...
public  final class CreateUserRequest extends
  ...
  public static com.proto.user.CreateUserRequest parseFrom(
  ...
  public static com.proto.user.CreateUserRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static com.proto.user.CreateUserRequest parseFrom(java.io.InputStream input)
  ...
  public static com.proto.user.CreateUserRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static com.proto.user.CreateUserRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(com.proto.user.CreateUserRequest prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.proto.user.CreateUserRequest, Builder> implements
      // @@protoc_insertion_point(builder_implements:user.CreateUserRequest)
      com.proto.user.CreateUserRequestOrBuilder {
    // Construct using com.proto.user.CreateUserRequest.newBuilder()
    private Builder() {
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.proto.user.CreateUserRequest();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<com.proto.user.CreateUserRequest> parser = PARSER;
        if (parser == null) {
          synchronized (com.proto.user.CreateUserRequest.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<com.proto.user.CreateUserRequest>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  private static final com.proto.user.CreateUserRequest DEFAULT_INSTANCE;
  static {
  ...
  public static com.proto.user.CreateUserRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
